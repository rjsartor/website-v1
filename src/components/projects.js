    ...
    return (
      <div className='projects'>
        ...
        <li className='project-item'>
            <a href="https://road-rate-client.herokuapp.com/" className="picture-link" target="_blank" rel="noopener noreferrer"><img src={require('../images/roadRate.png')} alt='roadRate dashboard' className='responsive'></img></a>   
          ...
          <li className='project-item'>
              <a href="https://frenchmate.herokuapp.com/" className="picture-link" target="_blank" rel="noopener noreferrer"><img src={require('../images/frenchMate.png')} alt='frenchMate landingpage' className='responsive'></img></a>  
              <div className='project-info'>
                <h2>
